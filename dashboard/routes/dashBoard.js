		...
		.get("/:threadID/:command", [isAuthenticated, isVeryfiUserIDFacebook, checkHasAndInThread], async (req, res) => {
			...
			switch (command) {
				case "welcome": {
					...
					variables.defaultWelcomeMessage = global.CowBot.configCommands.envEvents.welcome.defaultWelcomeMessage;
				...
				case "leave": {
					...
					variables.defaultLeaveMessage = global.CowBot.configCommands.envEvents.leave.defaultLeaveMessage;
